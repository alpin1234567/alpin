...
*/
const XPTN = 'ALFIN'; // Nama Bot Whatsapp
const instagram = '1'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6289690719275'; // Nomor whatsapplu cok
const aktif = '24 jam'; // Kapan bot lu aktif
const groupwa = 'kagak adaL'; // OFFICIAL GRUP LU 1
const youtube = 'ngapain youtube YouTube?'; // OFFICIAL GRUP LU 2
//
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] alpin ofc Ready scan now!`);
});
...
conn.sendMessage(id, 'Owner alpinT wa.me/+6289690719275' ,MessageType.text);
}
...
conn.sendMessage(id, ' *COMMAND kosong* ' ,MessageType.text);
}
else if (text == 'Woi'){
conn.sendMessage(id, 'Ya?, Ketik .help/.info/.donasi Contoh #help' ,MessageType.text);
}
...
conn.sendMessage(id, 'SUM Add Sum asik dia wa.me/+6289690719275' ,MessageType.text);
}
else if (text == '.coowner'){
conn.sendMessage(id, 'PUTRA add Putra wa.me/+6289690719275' ,MessageType.text);
}
else if (text == '.groupbot'){
conn.sendMessage(id, 'group bot kagak ada /' ,MessageType.text);
}
else if (text == '.tools1'){
...
conn.sendMessage(id, ' _🤖BOT MENGUCAPKAN TERIMAKASIH🤖💌UNTUK BUAT BOT TOTON CHANEL BANGLENT :https://youtube.com/channel/UCPfM-qelpkAnDwBPF00k_XQ👈' ,MessageType.text);
}
else if (text == '.tools1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾alpin👾* , gw kagak main ajg' ,MessageType.text);
}
else if (text == '.menu'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾alpin👾* ,btw lu komtol:v' ,MessageType.text);
}
else if (text == '.tool2'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾alpin👾* , 1' ,MessageType.text);
}
else if (text == '.tools3'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾alpin👾* , 2' ,MessageType.text);
}
else if (text == '.tools4'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾alpin👾* ,696969:v' ,MessageType.text);
}
else if (text == '.tools5'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾alpin👾* , Follow Instagram Mimin Yah😻 : https://youtube.com/channel/UCPfM-qelpkAnDwBPF00k_XQ' ,MessageType.text);
}
